package io.replikativ.replidroid;
...
import io.replikativ.replidroid.R;
...
public class SplashActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (firstLaunch) {
            firstLaunch = false;
            setupSplash();
            App.loadAsynchronously("io.replikativ.replidroid.MainActivity",
                                   new Runnable() {
                                       @Override
                                       public void run() {
                                           proceed();
    ...
    public void proceed() {
        startActivity(new Intent("io.replikativ.replidroid.MAIN"));
        finish();
    }
